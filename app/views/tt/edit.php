...
<h1>تعديل فى قسم التطريز </h1>


<form action="<?php echo URLROOT ;?>PageTT/edit/<?php echo $data['id'] ; ?>" method="post">
  <div class="form-group">
    <label for="formGroupExampleInput">أسم المطبعة (صاحب الطباعة)</label>
    <input type="text" class="form-control" id="formGroupExampleInput" name="name_tt_man" 
    value="<?php echo $data['name_tt_man'] ; ?>">
  </div>
  <div class="form-group">
